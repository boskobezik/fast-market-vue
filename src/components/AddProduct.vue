      ...
      <md-card class="md-layout-item md-size-50 md-small-size-100">
        ...
        <md-card-content>
          <div class="md-layout md-gutter">
            <div class="md-layout-item md-small-size-100">
              <md-field :class="getValidationClass('productName')">
                ...
                <md-input name="product-name" id="product-name" autocomplete="given-name" v-model="form.productName" :disabled="sending" />
                <span class="md-error" v-if="!$v.form.productName.required">The first name is required</span>
                <span class="md-error" v-else-if="!$v.form.productName.minlength">Invalid first name</span>
              </md-field>
            </div>
            ...
            <div class="md-layout-item md-small-size-100">
              <md-field :class="getValidationClass('productOwner')">
                ...
                <md-input name="product-owner" id="product-owner" autocomplete="family-name" v-model="form.productOwner" :disabled="sending" />
                <span class="md-error" v-if="!$v.form.productOwner.required">The last name is required</span>
                <span class="md-error" v-else-if="!$v.form.productOwner.minlength">Invalid last name</span>
              </md-field>
            </div>
          </div>
          ...
          <md-card class="md-layout-item md-size-25 md-small-size-50">
            <md-card-media>
              <img :src="form.productImageUrl" alt="product image" style="height: 200px; width: 200px;">
            </md-card-media>            
          </md-card>
          <md-field :class="getValidationClass('productImageUrl')" >
            <label>Initial Value</label>
            <md-input v-model="form.productImageUrl" :disabled="sending"></md-input>
            <span class="md-error" v-if="!$v.form.productImageUrl.required">The image is required</span>
          </md-field>
        ...
        <md-card-actions>
          <md-button type="submit" class="md-primary" :disabled="sending">Add Product</md-button>
        </md-card-actions>
      </md-card>
